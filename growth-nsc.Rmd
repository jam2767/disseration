...
early.sort <- which(growth_nsc_data.10yr$succession == "Early")
early.dat <- growth_nsc_data.10yr[early.sort,]

early.lm <- lm(total.nsc ~ mean.2010.2001, data = early.dat)
summary(early.lm)

mid.sort <- which(growth_nsc_data.10yr$succession == "Mid")
mid.dat <- growth_nsc_data.10yr[mid.sort,]

mid.lm <- lm(total.nsc ~ mean.2010.2001, data = mid.dat)
summary(mid.lm)

late.sort <- which(growth_nsc_data.10yr$succession == "Late")
late.dat <- growth_nsc_data.10yr[late.sort,]

late.lm <- lm(total.nsc ~ mean.2010.2001, data = late.dat)
summary(late.lm)


succession.lm <- lm(total.nsc ~ mean.2010.2001 + mean.2010.2001*succession, data = growth_nsc_data.10yr)
summary(succession.lm)

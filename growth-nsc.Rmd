...
growth.nsc.spp.plot <- ggplot(growth_nsc_data.10yr, aes(x = mean.2010.2001, y = total.nsc)) +
  ...
  ggsave(filename = "/Users/josh/Dropbox/Dissertation/CH3_Growth_NSC/Growth_NSC_Spp.png", plot = growth.nsc.spp.plot, dpi = 600, width = 5, height = 10, units = "in")
...
####Spp plot for only significant species - to be included in Chapter. Larger Figure in Appendix
 ...
 growth.nsc.sig.spp.plot <- ggplot(sig.spp.dat, aes(x = mean.2010.2001, y = total.nsc)) +
  ...
  ggsave(filename = "/Users/josh/Dropbox/Dissertation/CH3_Growth_NSC/Growth_NSC_Spp.png", plot = growth.nsc.sig.spp.plot, dpi = 600, width = 5, height = 5, units = "in")
...
mortality.plot <- ggplot(mort.dat.fin, aes(x = Mortality14, y = total.nsc)) +
  geom_violin() + theme(axis.text.x = element_text(angle=0,hjust=.5,size=16)) +

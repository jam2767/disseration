...
growth.50yr.QC.increment.final$CANOPY15[ growth.50yr.QC.increment.final$CANOPY15 == "Co-Dominant"] <- "CoDominant"
...
#year
lm.year <- lm(INCREMENT ~ as.factor(YEAR), data = growth.50yr.QC.increment.final)
summary(lm.year)
...
wood.growth.violin <- ggplot(growth.50yr.QC.increment.final, aes(x = WOOD, y = INCREMENT, fill = WOOD))+
  ...
  annotate("text", x = 1, y = 15.75, label = wood.n[1], size = 3.5) +
  annotate("text", x = 2, y = 15.75, label = wood.n[2], size = 3.5) +
  annotate("text", x = 3, y = 15.75, label = wood.n[3], size = 3.5) +
  annotate("text", x = 4, y = 15.75, label = wood.n[4], size = 3.5) +
  annotate("text", x = 5, y = 15.75, label = wood.n[5], size = 3.5) +
  annotate("text", x = 6, y = 15.75, label = wood.n[6], size = 3.5) +
  ...
  ylim(0,5) +
  annotate("text", x = 1.1:6.1, y = c(5, 4.7, 5, 5, 5, 5), label = c("e","a","b","b","c","d"))
...
canopy.growth.violin <- ggplot(growth.50yr.QC.increment.final, aes(x = as.factor(CANOPY15), y = INCREMENT, fill = CANOPY15))+
  geom_violin() + theme(axis.text.x = element_text(angle=45,hjust=1,size=16)) +
  theme(axis.text.y = element_text(size=12)) +
  theme(axis.title.x = element_text(size=14)) +
  theme(axis.title.y = element_text(size=14)) +
  ...
  theme(legend.text = element_blank()) +
  theme(legend.position = "none") +
  annotate("text", x = 1, y = 15.5, label = canopy.n[1], size = 3.5) +
  annotate("text", x = 2, y = 15.5, label = canopy.n[2], size = 3.5) +
  annotate("text", x = 3, y = 15.5, label = canopy.n[3], size = 3.5) +
  ...
  scale_fill_manual(values=rev(cbPalette)) +
  annotate("text", x = 1:3, y = c(9.5, 14.2, 11.5), label = c("c","a","b"))
...
#pft
lm.pft.simp <- lm(INCREMENT ~ PFT, data = growth.50yr.QC.increment.final)
summary(lm.pft.simp)
...
pft.growth.violin <- ggplot(growth.50yr.QC.increment.final, aes(x = PFT, y = INCREMENT, fill = PFT))+
  ...
  theme(legend.text = element_blank()) +
  theme(legend.position = "none") +
  annotate("text", x = 1, y = 14.8, label = pft.n[1], size = 3.5) +
  annotate("text", x = 2, y = 14.8, label = pft.n[2], size = 3.5) +
  annotate("text", x = 3, y = 14.8, label = pft.n[3], size = 3.5) +
  annotate("text", x = 4, y = 14.8, label = pft.n[4], size = 3.5) +
  annotate("text", x = 5, y = 14.8, label = pft.n[5], size = 3.5) +
  #stat_summary(fun.data = give.n, geom= "text", size = 3.5, aes(y= 13)) + 
  stat_summary(fun.y="median", geom="point") +
  ylim(0,5) +
  ...
  scale_fill_manual(values=rev(cbPalette)) +
  annotate("text", x = 1:5, y = c(10.75, 7.6, 12.8, 13.9, 10.25), label = c("e","a","b","c","d"))
...
#DBH
lm.size.simp <- lm(INCREMENT ~ DBH14, data = growth.50yr.QC.increment.final)
summary(lm.size.simp)

dbh.growth.plot <- ggplot(growth.50yr.QC.increment.final, aes(x = DBH14, y = INCREMENT)) +
  geom_point(alpha = .1) +
...
#avg growth and DBH
lm.size.avg <- lm(mean.growth.50yr.QC ~ DBH14, data = mean.growth.fig.data.50yr.QC)
summary(lm.size.avg)

plot(mean.growth.50yr.QC ~ DBH14, data = mean.growth.fig.data.50yr.QC)
abline(lm.size.avg)

dbh.growth.plot.avg <- ggplot(mean.growth.fig.data.50yr.QC, aes(x = DBH14, y = mean.growth.50yr.QC)) +
  geom_point(alpha = .3) +
  #geom_smooth(method = "gam", formula = y ~ s(x), size = 1, aes(color = "blue")) + # GAM model with smooth
  geom_smooth(method = "lm", aes(color = "yellow")) +
  theme(axis.title.y = element_text(size = 14)) +
...
#genus/species
lm.genus.simp <- lm(INCREMENT ~ genus/GenusSpecies, data = growth.50yr.QC.increment.final)
summary(lm.genus.simp)
...
#site
lm.site.simp <- lm(INCREMENT ~ SITE, data = growth.50yr.QC.increment.final)
...
site.growth.violin <- ggplot(growth.50yr.QC.increment.final, aes(x = SITE, y = INCREMENT))+
  ...
  theme(legend.text = element_blank()) +
  theme(legend.position = "none") +
  annotate("text", x = 1, y = 14.8, label = site.n[1], size = 3.5) +
  annotate("text", x = 2, y = 14.8, label = site.n[2], size = 3.5) +
  annotate("text", x = 3, y = 14.8, label = site.n[3], size = 3.5) +
  annotate("text", x = 4, y = 14.8, label = site.n[4], size = 3.5) +
  annotate("text", x = 5, y = 14.8, label = site.n[5], size = 3.5) +
  # annotate("text", x = 6, y = 14.8, label = site.n[6], size = 3.5) +
  annotate("text", x = 6, y = 14.8, label = site.n[7], size = 3.5) +
  annotate("text", x = 7, y = 14.8, label = site.n[8], size = 3.5) +
  annotate("text", x = 8, y = 14.8, label = site.n[9], size = 3.5) +
  annotate("text", x = 9, y = 14.8, label = site.n[10], size = 3.5) +
  #stat_summary(fun.data = give.n, geom= "text", size = 3.5, aes(y= 13)) + 
  stat_summary(fun.y="median", geom="point") +
  ylim(0,5) +
  ...
  scale_fill_manual(values=rev(cbPalette)) +
  annotate("text", x = 1:9, y = c(8, 12.75, 10.6, 13.8, 11.9, 9.5, 7.35, 11.25, 12.25), label = c("a","a","b","c","d","e","bcd","bd","bcd"))
...
#precipitation
lm.precip.simp <- lm(INCREMENT ~ PRECIP, data = growth.50yr.QC.increment.final)
summary(lm.precip.simp)

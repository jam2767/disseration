...
# lm.space.annual <- lm(INCREMENT ~ SITE/PLOT/SUB/CORE_ID15, data = combined.all.diss.common)
# anova.space.annual <- anova(lm.space.annual)
# summary(lm.space.annual)
...
full.vars <- as.data.frame(VarCorr(lmer.full.annual, order = "cov.last")) #random effect variances

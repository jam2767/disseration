...
lmer.full.annual <- lmer(INCREMENT ~ PFT + CANOPY15 + DBH15 + (1|SITE/PLOT/SUB/CORE_ID15) + (1|GenusSpecies) + (1|YEAR) + (1|SITE:YEAR) + (1|GenusSpecies:SITE) + (1|PFT:SITE), data = combined.all.diss.common)

...
#similar to NSC figure, show mean growth rate by species and color by PFT#
#just growth years 1961 - 2010
growth.50yr.QC <- combined.diss.clim.common.order.50.QC[,108:157]
mean.growth.50yr.QC <- rowMeans(growth.50yr.QC)
mean.growth.fig.data.50yr.QC <- cbind(combined.diss.clim.common.order.50.QC, mean.growth.50yr.QC)
...
#PFT
pft.violin <- ggplot(combined.all.diss.common.50.QC, aes(x = PFT, y = INCREMENT)) + #, fill = PFT

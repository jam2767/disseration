...
lmer.full.annual <- lmer(INCREMENT ~ PFT + DBH15 + CANOPY15 + (1|SITE/PLOT/SUB/CORE_ID15) + (1|GenusSpecies) + (1|YEAR) + (1|SITE:YEAR) + (1|GenusSpecies:SITE) + (1|PFT:SITE))

#Space ANNUAL Growth
lm.space.annual <- lm(INCREMENT ~ YEAR + SITE/PLOT/SUB, data = combined.all.diss.common)
anova(lm.space.simp)

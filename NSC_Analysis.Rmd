...
#Order ANOVA
lm.order.total <- lm(total.nsc ~ order, data = nsc.adult.total.mass)
anova(lm.order.total)
summary(lm.order.total) #R^2 = .3566

#Order ggplot, can also make violin plot
ggplot(nsc.adult.total.mass, aes(x = order, y = total.nsc, fill = "red")) + #need more colors for fill based on order
  geom_boxplot() + theme(axis.text.x = element_text(angle=45,hjust=1,size=12)) +
  theme(axis.text.y = element_text(size=16)) +
  theme(axis.title.x = element_text(size=20)) +
  theme(axis.title.y = element_text(size=20)) +
...
#Subclass ANOVA
lm.subclass.total <- lm(total.nsc ~ subclass, data = nsc.adult.total.mass)
anova(lm.subclass.total)
summary(lm.subclass.total) #R^2 = .3192

#Subclass ggplot, can also make violin plot
ggplot(nsc.adult.total.mass, aes(x = subclass, y = total.nsc, fill = "red")) + #need more colors for fill based on order
  geom_boxplot() + theme(axis.text.x = element_text(angle=45,hjust=1,size=12)) +
  theme(axis.text.y = element_text(size=16)) +
  theme(axis.title.x = element_text(size=20)) +
  theme(axis.title.y = element_text(size=20)) +
...
ggplot(nsc.adult.total.mass, aes(x = wood, y = total.nsc, fill = wood)) +
  ...
  theme(axis.title.y = element_text(size=20)) +
  theme(legend.text = element_text(size=16)) +
  stat_summary(fun.data = give.n, geom= "text", size = 4, aes(y= 160)) + 
...
lm.mortality <- lm(total.nsc ~ Mortality15, data = nsc.adult.total.mass)
anova(lm.mortality)
summary(lm.mortality)

ggplot(nsc.adult.total.mass, aes(x = Mortality15, y = total.nsc, fill = Mortality15)) +
  geom_boxplot() + theme(axis.text.x = element_text(angle=45,hjust=1,size=16)) +
  theme(axis.text.y = element_text(size=16)) +
  theme(axis.title.x = element_text(size=20)) +
  theme(axis.title.y = element_text(size=20)) +
...
```{r}
#starch v. total NSC
lm.starch2total <- lm(total.nsc ~ starch.mg.g, data = nsc.adult.total.mass)
...
#glucose v total NSC
lm.glucose2total <- lm(total.nsc ~ glucose.mg.g, data = nsc.adult.total.mass)
...
lm.fructose2total <- lm(total.nsc ~ fructose.mg.g, data = nsc.adult.total.mass)
...
#sucrose v total NSC
lm.sucrose2total <- lm(total.nsc ~ sucrose.mg.g, data = nsc.adult.total.mass)

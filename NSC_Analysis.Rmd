...
nsc.species <- ggplot(nsc.adult.total.mass.alive.common, aes(x = GenusSpecies, y = total.nsc, fill = wood)) + 
  ...
  labs(fill = "Wood\nAnatomy") +
  stat_summary(fun.data = give.n, geom= "text", size = 3, aes(y= 160)) + 
...
#PFT ggplot boxplot
ggplot(nsc.adult.total.mass.alive.common, aes(x = PFT, y = total.nsc, fill = PFT)) +
...
ggplot(nsc.adult.total.mass.alive.common, aes(x = wood, y = total.nsc, fill = wood)) +
...
ggplot(nsc.adult.total.mass.alive.common, aes(x = Canopy15, y = total.nsc, fill = Canopy15)) +
  geom_boxplot() + theme(axis.text.x = element_text(angle=45,hjust=1,size=16)) +
  theme(axis.text.y = element_text(size=16)) +
  theme(axis.title.x = element_text(size=20)) +
  theme(axis.title.y = element_text(size=20)) +
...
ggplot(nsc.adult.total.mass.alive.common, aes(x = Site, y = total.nsc, fill = "red")) +
  geom_boxplot() + theme(axis.text.x = element_text(angle=45,hjust=1,size=16)) +
  theme(axis.text.y = element_text(size=16)) +
  theme(axis.title.x = element_text(size=20)) +
  theme(axis.title.y = element_text(size=20)) +
...
q.violin.starch <- qplot(Tag, starch.mg.g, data = nsc.adult.total.mass.alive.common, geom = "violin", xlab = "Starch", ylab = "", ylim=c(0,105))

q.violin.glucose <- qplot(Tag, glucose.mg.g, data = nsc.adult.total.mass.alive.common, geom = "violin",xlab = "Glucose", ylab = expression(paste("Concentration mg g"^"-1")), ylim=c(0,105))

q.violin.fructose <- qplot(Tag, fructose.mg.g, data = nsc.adult.total.mass.alive.common, geom = "violin", xlab= "Fructose", ylab = "", ylim=c(0,105))

q.violin.sucrose <- qplot(Tag, sucrose.mg.g, data = nsc.adult.total.mass.alive.common, geom = "violin", xlab ="Sucrose", ylab = "", ylim=c(0,105))

violin.glucose <- ggplot(nsc.adult.total.mass.alive.common, aes(x = Tag, y = glucose.mg.g)) +
  geom_violin() +
...
violin.fructose <- ggplot(nsc.adult.total.mass.alive.common, aes(x = Tag, y = fructose.mg.g)) +
  geom_violin() +
  theme(axis.text.x = element_blank()) +
  theme(axis.ticks.x = element_blank()) +
...
violin.sucrose <- ggplot(nsc.adult.total.mass.alive.common, aes(x = Tag, y = sucrose.mg.g)) +
  geom_violin() +
  theme(axis.text.x = element_blank()) +
  theme(axis.ticks.x = element_blank()) +
  theme(axis.ticks.y = element_blank()) +
...
violin.starch <- ggplot(nsc.adult.total.mass.alive.common, aes(x = Tag, y = starch.mg.g)) +
  geom_violin() +
  theme(axis.text.x = element_blank()) +
  theme(axis.ticks.x = element_blank()) +
  theme(axis.ticks.y = element_blank()) +
...
nsc.components <- grid.arrange(violin.glucose, violin.fructose, violin.sucrose, violin.starch, ncol = 4)

...
#Full model with effects specified correctly - used in final dissertation draft!
nsc.full.lm <- lmer(total.nsc ~ DBH14 + Canopy15 + PFT + wood + (1|Site/Plot/Sub) + (1|subclass/order/family/genus/GenusSpecies) + (1|GenusSpecies:Site) + (1|TEMP_C), nsc.adult.total.mass.alive.common)
summary(nsc.full.lm)
anova(nsc.full.lm)
plot((nsc.full.lm))
